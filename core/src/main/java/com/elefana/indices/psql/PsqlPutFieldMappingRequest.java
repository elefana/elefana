...
public class PsqlPutFieldMappingRequest extends PutFieldMappingRequest implements Callable<PutFieldMappingResponse> {
	...
	@Override
	protected Callable<PutFieldMappingResponse> internalExecute() {
		return this;
	}

	@Override
	public PutFieldMappingResponse call() throws Exception {
		if(type != null) {
			indexFieldMappingService.putMapping(index, type, mappings);
		} else {
			indexFieldMappingService.putMapping(index, mappings);
		}
		return new PutFieldMappingResponse();
	}
}

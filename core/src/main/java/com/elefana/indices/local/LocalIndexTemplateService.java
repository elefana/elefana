...
@Service
public class LocalIndexTemplateService implements IndexTemplateService {
	private static final Logger LOGGER = LoggerFactory.getLogger(LocalIndexTemplateService.class);
	...
	public GetIndexTemplateRequest prepareGetIndexTemplates(String... templateIds) {
		return new LocalGetIndexTemplateRequest(this, templateIds);
	}

	@Override
	public PutIndexTemplateRequest preparePutIndexTemplate(String templateId, String requestBody) {
		return new LocalPutIndexTemplateRequest(this, templateId, requestBody);
	}

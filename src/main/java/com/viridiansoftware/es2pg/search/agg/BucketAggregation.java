...
public class BucketAggregation extends Aggregation {
	...
	public void writeFieldName(String name) throws IOException {
		...
		if(subaggregations.isEmpty() || subaggregations.get(subaggregations.size() - 1).isContextFinished()) {
	...
	public void writeStartObject() throws IOException {
		...
		if(subaggregations.get(subaggregations.size() - 1).isContextFinished()) {
			return;
		}
		subaggregations.get(subaggregations.size() - 1).writeStartObject();
	}
	...
	public void writeEndObject() throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeEndObject();
	}
	...
	public void writeStartArray() throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeStartArray();
	}
	...
	public void writeEndArray() throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeEndArray();
	}
	...
	public void writeNull() throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeNull();
	}
	...
	public void writeNullField(String name) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeNullField(name);
	}
	...
	public void writeBooleanField(String name, boolean value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeBooleanField(name, value);
	}
	...
	public void writeBoolean(boolean value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeBoolean(value);
	}
	...
	public void writeNumberField(String name, double value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeNumberField(name, value);
	}
	...
	public void writeNumber(double value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeNumber(value);
	}
	...
	public void writeStringField(String name, String value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeStringField(name, value);
	}
	...
	public void writeString(String value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeString(value);
	}
	...
	public void writeString(char[] text, int offset, int len) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeString(text, offset, len);
	}
	...
	public void writeUTF8String(byte[] value, int offset, int length) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeUTF8String(value, offset, length);
	}
	...
	public void writeBinaryField(String name, byte[] value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeBinaryField(name, value);
	}
	...
	public void writeBinary(byte[] value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeBinary(value);
	}
	...
	public void writeBinary(byte[] value, int offset, int length) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeBinary(value, offset, length);
	}
	...
	public void writeRawField(String name, InputStream value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeRawField(name, value);
	}
	...
	public void writeRawField(String name, InputStream value, XContentType xContentType) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeRawField(name, value, xContentType);
	}
	...
	public void writeRawValue(BytesReference value) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeRawValue(value);
	}
	...
	public void writeRawValue(BytesReference value, XContentType xContentType) throws IOException {
		...
		subaggregations.get(subaggregations.size() - 1).writeRawValue(value, xContentType);
	}

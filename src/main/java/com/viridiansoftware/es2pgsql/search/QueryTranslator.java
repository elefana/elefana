...
import com.viridiansoftware.es2pgsql.search.query.BoolQuery;
import com.viridiansoftware.es2pgsql.search.query.ConstantScoreQuery;
import com.viridiansoftware.es2pgsql.search.query.ExistsQuery;
import com.viridiansoftware.es2pgsql.search.query.MatchAllQuery;
import com.viridiansoftware.es2pgsql.search.query.MatchPhrasePrefixQuery;
import com.viridiansoftware.es2pgsql.search.query.MatchPhraseQuery;
import com.viridiansoftware.es2pgsql.search.query.MatchQuery;
import com.viridiansoftware.es2pgsql.search.query.MultiMatchQuery;
import com.viridiansoftware.es2pgsql.search.query.PrefixQuery;
import com.viridiansoftware.es2pgsql.search.query.QuerySpec;
import com.viridiansoftware.es2pgsql.search.query.QueryType;
import com.viridiansoftware.es2pgsql.search.query.RangeQuery;
import com.viridiansoftware.es2pgsql.search.query.RegexpQuery;
import com.viridiansoftware.es2pgsql.search.query.TermQuery;
import com.viridiansoftware.es2pgsql.search.query.TypeQuery;
import com.viridiansoftware.es2pgsql.search.query.WildcardQuery;

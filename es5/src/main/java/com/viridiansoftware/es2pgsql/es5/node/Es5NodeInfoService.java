 ...
 */
package com.viridiansoftware.es2pgsql.es5.node;
...
import com.viridiansoftware.es2pgsql.es5.util.MapXContentBuilder;
import com.viridiansoftware.es2pgsql.node.NodeInfoService;

@Service
public class Es5NodeInfoService extends NodeInfoService {

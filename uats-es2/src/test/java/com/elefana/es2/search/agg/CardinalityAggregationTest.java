...
public class CardinalityAggregationTest extends AbstractAggregationTest {

	@Test
	public void testCardinalityAggregation() {
		Set<Integer> cardinality = new HashSet<Integer>();
		...
		.then()
			...
			.body("aggregations.aggs_result.value", equalTo(cardinality.size()));
	}
}
